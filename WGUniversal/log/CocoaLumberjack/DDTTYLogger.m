...
#define NSLogError(frmt, ...)    do{ if(LOG_LEVEL >= 1) { if (LOG_REMOTE==0) NSLog((frmt), ##__VA_ARGS__); else LogMessageCompat((frmt), ##__VA_ARGS__);} } while(0)
#define NSLogWarn(frmt, ...)     do{ if(LOG_LEVEL >= 2) { if (LOG_REMOTE==0) NSLog((frmt), ##__VA_ARGS__); else LogMessageCompat((frmt), ##__VA_ARGS__);} } while(0)
#define NSLogInfo(frmt, ...)     do{ if(LOG_LEVEL >= 3) { if (LOG_REMOTE==0) NSLog((frmt), ##__VA_ARGS__); else LogMessageCompat((frmt), ##__VA_ARGS__);} } while(0)
#define NSLogVerbose(frmt, ...)  do{ if(LOG_LEVEL >= 4) { if (LOG_REMOTE==0) NSLog((frmt), ##__VA_ARGS__); else LogMessageCompat((frmt), ##__VA_ARGS__);} } while(0)
